...
export const RESOLVERS: Record<string, Resolver> = {
  ...
  '/clients/:id/integrations/housecallpro': 'client',
  ...
  '/clients/:id/notifications-summary': 'client',
  ...
  '/clients/:id/reports/orders': 'client',
  ...
  '/clients/:id/tracking-health': 'client',
  '/clients/:id/creative-tags': 'client',
  '/clients/:id/creative-tags/generate': 'client',
  '/clients/:id/creative-tags/performance': 'client',
  ...
  '/tracking-health/:id/dismiss': (req) =>
    clientIdFrom('tracking_health_signals', 'id', (req.params as { id: string }).id),
